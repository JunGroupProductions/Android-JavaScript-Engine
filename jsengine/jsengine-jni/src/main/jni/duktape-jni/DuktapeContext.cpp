...
DuktapeContext::DuktapeContext(JavaVM* javaVM, jobject javaDuktape)
  ...
  jclass duktapeJavaObject = findClass(env, "com/abc/core/jsengine/QuackJavaObject");

  m_duktapeClass = findClass(env, "com/abc/core/jsengine/QuackContext");
  m_duktapeObjectClass = findClass(env, "com/abc/core/jsengine/QuackObject");
  ...
  m_jsonObjectClass = findClass(env, "com/abc/core/jsengine/QuackJsonObject");
  m_byteBufferClass = findClass(env, "java/nio/ByteBuffer");

  m_duktapeHasMethod = env->GetMethodID(m_duktapeClass, "quackHas", "(Lcom/abc/core/jsengine/QuackObject;Ljava/lang/Object;)Z");
  m_duktapeGetMethod = env->GetMethodID(m_duktapeClass, "quackGet", "(Lcom/abc/core/jsengine/QuackObject;Ljava/lang/Object;)Ljava/lang/Object;");
  m_duktapeSetMethod = env->GetMethodID(m_duktapeClass, "quackSet", "(Lcom/abc/core/jsengine/QuackObject;Ljava/lang/Object;Ljava/lang/Object;)Z");
  m_duktapeCallMethodMethod = env->GetMethodID(m_duktapeClass, "quackApply", "(Lcom/abc/core/jsengine/QuackObject;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;");

  m_javaScriptObjectConstructor = env->GetMethodID(m_javaScriptObjectClass, "<init>", "(Lcom/abc/core/jsengine/QuackContext;JJ)V");
  m_javaObjectConstructor = env->GetMethodID(m_javaObjectClass, "<init>", "(Lcom/abc/core/jsengine/QuackContext;Ljava/lang/Object;)V");
...
void queueDuktapeException(JNIEnv* env, const std::string& message) {
  const jclass exceptionClass = env->FindClass("com/abc/core/jsengine/QuackException");
...
bool checkRethrowDuktapeErrorInternal(JNIEnv* env, duk_context* ctx) {
  ...
  jclass exceptionClass = env->FindClass("com/abc/core/jsengine/QuackException");
