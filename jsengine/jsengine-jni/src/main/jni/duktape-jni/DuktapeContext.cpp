...
DuktapeContext::DuktapeContext(JavaVM* javaVM, jobject javaDuktape)
  ...
  jclass duktapeJavaObject = findClass(env, "com/hyprmx/android/jsengine/JSEngineJavaObject");

  m_duktapeClass = findClass(env, "com/hyprmx/android/jsengine/JSEngineContext");
  m_duktapeObjectClass = findClass(env, "com/hyprmx/android/jsengine/JSEngineObject");
  m_javaScriptObjectClass = findClass(env, "com/hyprmx/android/jsengine/JavaScriptObject");
  m_javaObjectClass = findClass(env, "com/hyprmx/android/jsengine/JavaObject");
  m_jsonObjectClass = findClass(env, "com/hyprmx/android/jsengine/JSEngineJsonObject");
  m_byteBufferClass = findClass(env, "java/nio/ByteBuffer");

  m_duktapeHasMethod = env->GetMethodID(m_duktapeClass, "proxyHas", "(Lcom/hyprmx/android/jsengine/JSEngineObject;Ljava/lang/Object;)Z");
  m_duktapeGetMethod = env->GetMethodID(m_duktapeClass, "proxyGet", "(Lcom/hyprmx/android/jsengine/JSEngineObject;Ljava/lang/Object;)Ljava/lang/Object;");
  m_duktapeSetMethod = env->GetMethodID(m_duktapeClass, "proxySet", "(Lcom/hyprmx/android/jsengine/JSEngineObject;Ljava/lang/Object;Ljava/lang/Object;)Z");
  m_duktapeCallMethodMethod = env->GetMethodID(m_duktapeClass, "proxyApply", "(Lcom/hyprmx/android/jsengine/JSEngineObject;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;");

  m_javaScriptObjectConstructor = env->GetMethodID(m_javaScriptObjectClass, "<init>", "(Lcom/hyprmx/android/jsengine/JSEngineContext;JJ)V");
  m_javaObjectConstructor = env->GetMethodID(m_javaObjectClass, "<init>", "(Lcom/hyprmx/android/jsengine/JSEngineContext;Ljava/lang/Object;)V");
...
void queueDuktapeException(JNIEnv* env, const std::string& message) {
  const jclass exceptionClass = env->FindClass("com/hyprmx/android/jsengine/JSEngineException");
...
bool checkRethrowDuktapeErrorInternal(JNIEnv* env, duk_context* ctx) {
  ...
  jclass exceptionClass = env->FindClass("com/hyprmx/android/jsengine/JSEngineException");
